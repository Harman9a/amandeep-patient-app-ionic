...
export class ProfilePage implements OnInit {
  ...
  constructor(private statusBar: StatusBar, private platform: Platform, private location: Location, private route: ActivatedRoute, private router: Router, private http: HttpService, public utility: UtilityService) {
