...
export class SignUpPage implements OnInit {
  ...
  signup() {
    ...
    if (this.name == undefined) {
    ...
    } else if (this.country_status == undefined) {
      this.utility.showMessageAlert("Error!", "Please select country");
      ...
      this.utility.showMessageAlert(
        "Error!",
        "Password should be atlest 8 characters"
      );
    } else {
  ...
  openTerms() {
    console.log("ok");
    window.open("https://amandeephospital.org/privacy-policy.php");
  }
}
